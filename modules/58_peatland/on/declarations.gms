...
equations
 ...
 q58_net_expansion_degrad(j)					Net expansion of degraded area (mio. ha)
 q58_peatland_intact(j)							Intact peatland area constraint (mio. ha)
...
positive variables
 ...
 v58_net_expansion_degrad(j)				Net expansion of degrade peatland (mio. ha)
...
parameters
 ...
 ov58_net_expansion_degrad(t,j,type)                  Net expansion of degrade peatland (mio. ha)
 ...
 oq58_net_expansion_degrad(t,j,type)                  Net expansion of degraded area (mio. ha)
 oq58_peatland_intact(t,j,type)                       Intact peatland area constraint (mio. ha)
