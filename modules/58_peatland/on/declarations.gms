...
equations
 ...
 q58_peatland_rewet_crop(j)						Rewetted peatland crop constraint (mio. ha)
 q58_peatland_rewet_past(j)						Rewetted peatland past constraint (mio. ha)
 q58_peatland_rewet_forestry(j)					Rewetted peatland forestry constraint (mio. ha)
...
parameters
 ...
 oq58_peatland_rewet_crop(t,j,type)                   Rewetted peatland crop constraint (mio. ha)
 oq58_peatland_rewet_past(t,j,type)                   Rewetted peatland past constraint (mio. ha)
 oq58_peatland_rewet_forestry(t,j,type)               Rewetted peatland forestry constraint (mio. ha)
