...
parameters
 ...
 p58_mapping_cell_climate(j,climate58)				Mapping between cells and climate regions (binary)
...
equations
 ...
 q58_peatland_intact_degrad_crop(j)				Intact to degrad peatland crop constraint (mio. ha)
 q58_peatland_intact_degrad_past(j)				Intact to degrad peatland past constraint (mio. ha)
 q58_peatland_intact_degrad_forestry(j)			Intact to degrad peatland forestry constraint (mio. ha)
...
parameters
 ov58_peatland_emis(t,j,climate58,emis58,type)        Detailed GHG emissions from managed peatland (t CO2eq per year)
 ...
 oq58_peatland_intact_degrad_crop(t,j,type)           Intact to degrad peatland crop constraint (mio. ha)
 oq58_peatland_intact_degrad_past(t,j,type)           Intact to degrad peatland past constraint (mio. ha)
 oq58_peatland_intact_degrad_forestry(t,j,type)       Intact to degrad peatland forestry constraint (mio. ha)
 ...
 oq58_peatland_emis_detail(t,j,climate58,emis58,type) Detailed GHG emissions from managed peatland (t CO2eq per year)
