...
$ifThen "%c20_scp%" == "off"
	vm_prod_reg.fx(i,"scp")=0; 
$elseIf "%c20_scp%" == "begr"
	v20_processing_shares.fx(i,"scp","begr")=1;
	v20_processing_shares.fx(i,"scp","sugr_cane")=0;
$elseIf "%c20_scp%" == "sugar"
	v20_processing_shares.fx(i,"scp","begr")=0;
...
$elseIf "%c20_scp%" == "mixed_free"
	...
	v20_processing_shares.up(i,"scp","begr")=1;
	v20_processing_shares.lo(i,"scp","sugr_cane")=0;
	v20_processing_shares.up(i,"scp","sugr_cane")=1;	
$endif
