...
parameters
 ...
 i56_emis_policy(t,i,pollutants,emis_source)      GHG emission policy scenarios (binary)
 i56_c_price_induced_aff(t)						  C price driven afforestation switch (binary)
...
equations
 ...
 q56_reward_cdr_aff_limit(j)							  Cellular limit for afforestation revenues (mio. USD05MER per yr)
...
parameters
 ...
 oq56_reward_cdr_aff_limit(t,j,type)                             Cellular limit for afforestation revenues (mio. USD05MER per yr)
