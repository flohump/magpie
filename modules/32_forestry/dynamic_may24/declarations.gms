...
parameters
 ...
 p32_plant_rotation_yr(j)                           Cellular area-weighted external per-biome plantation rotation length (yr)
 ...
 p32_forestry_check                                 Forestry-area conservation check for the sub-pool initialisation (mio. ha)
...
positive variables
 ...
 v32_hvarea_forestry(j,harvest32,ac)                Harvested area from harvestable managed forestry (mio. ha)
 ...
 v32_land_replant(j,harvest32)                      Harvested and replanted area in harvestable managed forestry (mio. ha)
...
equations
 ...
 q32_hvarea_forestry(j,harvest32,ac)                Plantations area harvest (mio. ha)
 ...
 q32_establishment_hvarea(j,harvest32)             Establishment in current time step for future demand (mio. ha)
 q32_establishment_fixed(j,harvest32)               Establishment in current time step for future demand (mio. ha)
 ...
 q32_land_replant(j,harvest32)                     Harvested and replanted area in harvestable managed forestry (mio. ha)
...
parameters
 ...
 ov32_hvarea_forestry(t,j,harvest32,ac,type)   Harvested area from harvestable managed forestry (mio. ha)
 ...
 ov32_land_replant(t,j,harvest32,type)         Harvested and replanted area in harvestable managed forestry (mio. ha)
 ...
 oq32_hvarea_forestry(t,j,harvest32,ac,type)   Plantations area harvest (mio. ha)
 ...
 oq32_establishment_hvarea(t,j,harvest32,type) Establishment in current time step for future demand (mio. ha)
 oq32_establishment_fixed(t,j,harvest32,type)  Establishment in current time step for future demand (mio. ha)
 ...
 oq32_land_replant(t,j,harvest32,type)         Harvested and replanted area in harvestable managed forestry (mio. ha)
