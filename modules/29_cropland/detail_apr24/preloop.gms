...
if(s29_treecover_plantation = 0,
 p29_carbon_density_ac(t,j,ac,ag_pools) = pm_carbon_density_secdforest_ac_default(t,j,ac,ag_pools);
elseif s29_treecover_plantation = 1,
 p29_carbon_density_ac(t,j,ac,ag_pools) = pm_carbon_density_plantation_ac_default(t,j,ac,ag_pools);
);
