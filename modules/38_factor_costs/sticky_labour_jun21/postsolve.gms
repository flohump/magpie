...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ...
 ov38_capital_need(t,i,kcr,"marginal")        = v38_capital_need.m(i,kcr);
 ov38_labour_need(t,i,kcr,"marginal")         = v38_labour_need.m(i,kcr);
 ...
 ov38_capital_need(t,i,kcr,"level")           = v38_capital_need.l(i,kcr);
 ov38_labour_need(t,i,kcr,"level")            = v38_labour_need.l(i,kcr);
 ...
 ov38_capital_need(t,i,kcr,"upper")           = v38_capital_need.up(i,kcr);
 ov38_labour_need(t,i,kcr,"upper")            = v38_labour_need.up(i,kcr);
 ...
 ov38_capital_need(t,i,kcr,"lower")           = v38_capital_need.lo(i,kcr);
 ov38_labour_need(t,i,kcr,"lower")            = v38_labour_need.lo(i,kcr);
