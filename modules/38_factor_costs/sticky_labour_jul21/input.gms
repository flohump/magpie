...
/
$ondelim
$include "./modules/38_factor_costs/sticky_labour_jul21/input/f38_fac_req_fao.csv"
$offdelim
/
;
...
$ondelim
$include "./modules/38_factor_costs/sticky_labour_jul21/input/f38_region_yield.csv"
$offdelim;

parameter f38_reg_parameters(reg) Parameters for dynamic regression
/
$ondelim
$include "./modules/38_factor_costs/sticky_labour_jul21/input/f38_regression_cap_share.csv"
$offdelim
/
;
...
$ondelim
$include "./modules/38_factor_costs/sticky_labour_jul21/input/f38_historical_share.csv"
$offdelim
;
