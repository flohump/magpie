...
positive variables
 ...
 v38_capital_need(j,kcr)			   Capital required for one unit of output (USD05MER per ton DM)
...
parameters
 ...
 ov38_capital_need(t,j,kcr,type)        Capital required for one unit of output (USD05MER per ton DM)
