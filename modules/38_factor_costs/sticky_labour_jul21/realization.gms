...
$Ifi "%phase%" == "sets" $include "./modules/38_factor_costs/sticky_labour_jul21/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/38_factor_costs/sticky_labour_jul21/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/38_factor_costs/sticky_labour_jul21/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/38_factor_costs/sticky_labour_jul21/equations.gms"
$Ifi "%phase%" == "scaling" $include "./modules/38_factor_costs/sticky_labour_jul21/scaling.gms"
$Ifi "%phase%" == "preloop" $include "./modules/38_factor_costs/sticky_labour_jul21/preloop.gms"
$Ifi "%phase%" == "presolve" $include "./modules/38_factor_costs/sticky_labour_jul21/presolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/38_factor_costs/sticky_labour_jul21/postsolve.gms"
