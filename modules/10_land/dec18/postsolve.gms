...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ...
 ov_cost_lu_trans(t,j,"marginal")                          = vm_cost_lu_trans.m(j);
 ...
 ov10_landremain(t,j,land,"marginal")                      = v10_landremain.m(j,land);
 ...
 oq10_cost_lu_trans(t,j,"marginal")                        = q10_cost_lu_trans.m(j);
 oq10_landremain(t,j,land_to10,"marginal")                 = q10_landremain.m(j,land_to10);
 ...
 ov_cost_lu_trans(t,j,"level")                             = vm_cost_lu_trans.l(j);
 ...
 ov10_landremain(t,j,land,"level")                         = v10_landremain.l(j,land);
 ...
 oq10_cost_lu_trans(t,j,"level")                           = q10_cost_lu_trans.l(j);
 oq10_landremain(t,j,land_to10,"level")                    = q10_landremain.l(j,land_to10);
 ...
 ov_cost_lu_trans(t,j,"upper")                             = vm_cost_lu_trans.up(j);
 ...
 ov10_landremain(t,j,land,"upper")                         = v10_landremain.up(j,land);
 ...
 oq10_cost_lu_trans(t,j,"upper")                           = q10_cost_lu_trans.up(j);
 oq10_landremain(t,j,land_to10,"upper")                    = q10_landremain.up(j,land_to10);
 ...
 ov_cost_lu_trans(t,j,"lower")                             = vm_cost_lu_trans.lo(j);
 ...
 ov10_landremain(t,j,land,"lower")                         = v10_landremain.lo(j,land);
 ...
 oq10_cost_lu_trans(t,j,"lower")                           = q10_cost_lu_trans.lo(j);
 oq10_landremain(t,j,land_to10,"lower")                    = q10_landremain.lo(j,land_to10);
