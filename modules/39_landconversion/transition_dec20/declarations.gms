...
equations
 q39_cost_landcon(j)        	Calculation of cellular landconversion costs (mio. USD05MER per yr)
;
...
parameters
 ...
 i39_cost_transition(land_from10,land_to10)			         Global land establishment costs (USD05MER per hectare)
;
...
parameters
 ...
 oq39_cost_landcon(t,j,type)    Calculation of cellular landconversion costs (mio. USD05MER per yr)
;
