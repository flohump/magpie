...
* Primary-forest harvest cost is set equal to secondary forest, i.e. no extra premium on logging
* primary forest, so that timber sourcing and forest clearing are not steered away from primary forest.
s35_timber_harvest_cost_primforest   Cost for harvesting from primary forest (USD17MER per ha) / 2460 /
