...
q31_land(j2) ..
vm_land(j2,"past") =e=
sum(land_past, v31_land(j2,land_past));

q31_prod(j2) ..
 vm_prod(j2,"pasture") =l= sum(land_past, v31_prod_detail(j2,land_past));

q31_prod_manpast(j2) ..
 v31_prod_detail(j2,"manpast") =e= v31_land(j2,"manpast") * vm_yld(j2,"pasture","rainfed");

q31_prod_rangeland(j2) ..
 v31_prod_detail(j2,"rangeland") =e= v31_land(j2,"rangeland") * sum(ct,i14_yields_calib(ct,j2,"pasture","rainfed"));
...
*         sum(ct, vm_land(j2,"past")*fm_carbon_density(ct,j2,"past",ag_pools));
         sum(ct, v31_land(j2,"manpast")*fm_carbon_density(ct,j2,"crop",ag_pools))
        + sum(ct, v31_land(j2,"rangeland")*fm_carbon_density(ct,j2,"past",ag_pools));
...
q31_cost_prod_past(i2) ..
 vm_cost_prod(i2,"pasture") =e= sum(cell(i2,j2), v31_prod_detail(j2,"manpast"))
 								* s31_fac_req_past;
...
*' By estimating the different area of managed pasture and rangeland via the luh2 side layers, the biodiversity value for pastures and rangeland is calculated in following:
 q31_bv_manpast(j2,potnatveg) .. vm_bv(j2,"manpast",potnatveg)
 					=e=
 					v31_land(j2,"manpast") * fm_bii_coeff("manpast",potnatveg) * fm_luh2_side_layers(j2,potnatveg);

 q31_bv_rangeland(j2,potnatveg) .. vm_bv(j2,"rangeland",potnatveg)
 					=e=
 					v31_land(j2,"rangeland") * fm_bii_coeff("rangeland",potnatveg) * fm_luh2_side_layers(j2,potnatveg);
