...
$Ifi "%phase%" == "declarations" $include "./modules/31_past/manpast_rangeland/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/31_past/manpast_rangeland/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/31_past/manpast_rangeland/equations.gms"
$Ifi "%phase%" == "preloop" $include "./modules/31_past/manpast_rangeland/preloop.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/31_past/manpast_rangeland/postsolve.gms"
