...
equations
 ...
 q31_prod_manpast(j)
 q31_prod_rangeland(j)
 q31_land(j)
;

positive variables
 v31_land(j,land_past) blub (Mha)
 v31_prod_detail(j,land_past) blub (Mha)
;

*#################### R SECTION START (OUTPUT DECLARATIONS) ####################
parameters
 ov31_land(t,j,land_past,type)         blub (Mha)
 ov31_prod_detail(t,j,land_past,type)  blub (Mha)
 ...
 oq31_prod_manpast(t,j,type)           
 oq31_prod_rangeland(t,j,type)         
 oq31_land(t,j,type)                   
;
