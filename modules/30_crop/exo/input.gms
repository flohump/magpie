...
$ondelim
$include "./modules/30_crop/exo/input/f30_croparea_w_initialisation.cs3"
$offdelim
;
...
/
$ondelim
$include "./modules/30_crop/exo/input/f30_rotation_max.csv"
$offdelim
/;
...
/
$ondelim
$include "./modules/30_crop/exo/input/f30_rotation_min.csv"
$offdelim
/;
...
s30_adjustment_cost			Adjustment cost (USD) / 1000000000 /
;

table f30_avl_cropland(j,marginal_land30) Available land area for cropland (mio. ha)
$ondelim
$include "./modules/30_crop/exo/input/avl_cropland.cs3"
$offdelim
;

table f30_avl_cropland_iso(iso,marginal_land30) Available land area for cropland at ISO level (mio. ha)
$ondelim
$include "./modules/30_crop/exo/input/avl_cropland_iso.cs3"
$offdelim
;

table f30_set_aside_fader(t_all,set_aside_target30) Fader for share of set aside cropland (unitless)
$ondelim
$include "./modules/30_crop/exo/input/f30_set_aside_fader.csv"
$offdelim
;

table f30_croparea(t,j,kcr,w) Exogenous croparea pattern (mio. ha)
$ondelim
$include "./modules/30_crop/exo/input/f30_croparea.cs3"
$offdelim
;
