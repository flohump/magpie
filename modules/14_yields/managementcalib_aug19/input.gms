...
s14_minimum_wood_yield             Minimum wood yield for timber harvest in natural vegetation (tDM per ha) / 5 /
...
s14_carbon_fraction                Carbon fraction of dry matter (tC per tDM) / 0.5/
;
...
parameter f14_ipcc_bef(clcl) IPCC biomass expansion factor BEF (1)
/
$ondelim
...
parameter f14_aboveground_fraction(land_timber) Aboveground fraction of total biomass (1)
/
$ondelim
