...
p52_prim_area(i) = 0;
p52_secdf_area(i) = 0;
p52_secdf_ageclass(j,ac) = 0;
p52_fra_secdf_target(i) = 0;
p52_k_calib_secdf(i) = 0;
p52_k_calib_plant(i) = 0;
p52_gs_current(i) = 0;
p52_gs_current_plant(i) = 0;
pm_vol_conv(i) = 0.5;

* Save default (uncalibrated) growth curves before calibration overwrites pm_ params
pm_carbon_density_secdforest_ac_default(t_all,j,ac,ag_pools) = pm_carbon_density_secdforest_ac(t_all,j,ac,ag_pools);
pm_carbon_density_plantation_ac_default(t_all,j,ac,ag_pools) = pm_carbon_density_plantation_ac(t_all,j,ac,ag_pools);
