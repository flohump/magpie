...
loop(t_all,
 if(m_year(t_all) <= sm_fix_SSP2,
  ...
  im_governance_indicator(t_all,i) = f09_governance_indicator(t_all,i,"SSP2");
else
  ...
  im_governance_indicator(t_all,i) = f09_governance_indicator(t_all,i,"%c09_gdp_scenario%");
 );
);
